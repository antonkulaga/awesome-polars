...
- [genetic annotations as polars dataframes](https://github.com/antonkulaga/genotations) - Bioinformatic library that manipulates and downloads Ensembl genetic annotations and represents them as polars dataframes.
